...
The shortcut component uses a per-user registry key as its Windows Installer key path, as required by ICE validation for a non-advertised Start Menu shortcut. The package itself and application files are installed per-machine.
